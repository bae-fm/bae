...
|---|---|---|
| S3 uyumlu | Access key + secret | Eşleştirme sırasında onaylı cihaza mühürlenen kimlik bilgileri |
| Google Drive | OAuth (PKCE) | Yeni cihazın hesabı onaylandı ve ardından klasör paylaşıldı |
| Dropbox | OAuth (PKCE) | Yeni cihazın hesabı onaylandı ve ardından klasör paylaşıldı |
| OneDrive | OAuth (PKCE) | Yeni cihazın hesabı onaylandı ve ardından klasör paylaşıldı |
| iCloud (CloudKit) | Apple ID, giriş yok | Eşleştirme sırasında CloudKit paylaşımı kabul edildi |
