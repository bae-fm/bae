...
|---|---|---|
| Compatível com S3 | Chave de acesso + segredo | Credenciais seladas ao dispositivo aprovado durante o emparelhamento |
| Google Drive | OAuth (PKCE) | A conta do novo dispositivo é aprovada e a pasta é compartilhada |
| Dropbox | OAuth (PKCE) | A conta do novo dispositivo é aprovada e a pasta é compartilhada |
| OneDrive | OAuth (PKCE) | A conta do novo dispositivo é aprovada e a pasta é compartilhada |
| iCloud (CloudKit) | Apple ID, sem login | Compartilhamento do CloudKit aceito durante o emparelhamento |
