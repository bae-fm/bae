...
La chiave viaggia tra i dispositivi in ​​due modi, entrambi descritti in [Identità e appartenenza](/it/reference/membership): sigillata sulla chiave pubblica di un dispositivo approvato durante l'accoppiamento del dispositivo e trasportata all'interno di un codice di ripristino.
