...
Apps સાથે: `bae-mcp` (MCP server) અને `bae-automation`.
...
~/.bae/libraries/<id>/
  ...
  config.yaml       # coven: લાઇબ્રેરીની ઓળખ, ક્લાઉડ હોમ; ક્યારેય સિંક થતું નથી
  preferences.yaml  # bae ની સેટિંગ્સ; ક્યારેય સિંક થતી નથી
  storage/
