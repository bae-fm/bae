...
La clé voyage entre appareils de deux manières, toutes deux décrites dans [Identité et appartenance](/fr/reference/membership) : scellée avec la clé publique d’un appareil approuvé pendant une invitation, et portée dans un code de récupération.
