...
|---|---|---|
| S3-compatible | Access key + secret | Informations d'identification scellées sur l'appareil approuvé lors du couplage |
| Google Drive | OAuth (PKCE) | Le compte du nouvel appareil est approuvé, puis le dossier est partagé |
| Dropbox | OAuth (PKCE) | Le compte du nouvel appareil est approuvé, puis le dossier est partagé |
| OneDrive | OAuth (PKCE) | Le compte du nouvel appareil est approuvé, puis le dossier est partagé |
| iCloud (CloudKit) | Apple ID, no sign-in | Partage CloudKit accepté lors du couplage |
