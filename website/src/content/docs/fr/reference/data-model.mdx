...
- **`source_release_payloads`** : JSON brut archivé à partir de MusicBrainz et Discogs, codé par la version du fournisseur plutôt que par une version locale.Il prend en charge la réinitialisation exacte et la réinterprétation sans modifier le graphique du catalogue synchronisé.
