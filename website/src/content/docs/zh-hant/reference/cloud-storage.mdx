...
| 提供者 | 驗證 | 新裝置的存取權 |
|---|---|---|
| S3-compatible | Access key + secret | 配對期間將憑證密封到已核准的裝置上 |
| Google Drive | OAuth (PKCE) | 新設備的帳戶獲得批准，然後共享資料夾 |
| Dropbox | OAuth (PKCE) | 新設備的帳戶獲得批准，然後共享資料夾 |
| OneDrive | OAuth (PKCE) | 新設備的帳戶獲得批准，然後共享資料夾 |
| iCloud (CloudKit) | Apple ID，無需登入 | 配對期間接受 CloudKit 分享 |
