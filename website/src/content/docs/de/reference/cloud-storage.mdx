...
|---|---|---|
| S3-kompatibel | Access key + secret | Anmeldedaten werden während der Kopplung an das zugelassene Gerät versiegelt |
| Google Drive | OAuth (PKCE) | Das Konto des neuen Geräts wurde genehmigt, dann wird der Ordner freigegeben |
| Dropbox | OAuth (PKCE) | Das Konto des neuen Geräts wurde genehmigt, dann wird der Ordner freigegeben |
| OneDrive | OAuth (PKCE) | Das Konto des neuen Geräts wurde genehmigt, dann wird der Ordner freigegeben |
| iCloud (CloudKit) | Apple-ID, keine Anmeldung | CloudKit-Freigabe während der Kopplung akzeptiert |
