...
Ustawienie ** Domyślne źródło metadanych ** ma trzy wartości. ** Brak ** tworzy pustą wersję roboczą i nie rozpoczyna pracy z metadanymi. ** Tagi plików ** odczytuje i stosuje migawkę znacznika. ** Znajdź online ** otwiera przepływ pracy online; gdy ** Identyfikuj automatycznie ** jest włączony, ustawia również w kolejce ekstrakcję dowodów, zapytania dostawców i dopasowanie.
