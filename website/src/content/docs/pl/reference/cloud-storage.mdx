...
|---|---|---|
| Zgodny z S3 | Access key + secret | Dane uwierzytelniające przypisane do zatwierdzonego urządzenia podczas parowania |
| Google Drive | OAuth (PKCE) | Konto nowego urządzenia zostało zatwierdzone, następnie folder jest udostępniany |
| Dropbox | OAuth (PKCE) | Konto nowego urządzenia zostało zatwierdzone, następnie folder jest udostępniany |
| OneDrive | OAuth (PKCE) | Konto nowego urządzenia zostało zatwierdzone, następnie folder jest udostępniany |
| iCloud (CloudKit) | Apple ID, bez logowania | Udział CloudKit zaakceptowany podczas parowania |
