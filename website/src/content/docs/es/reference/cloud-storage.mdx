...
|---|---|---|
| Compatible con S3 | Access key + secret | Credenciales selladas al dispositivo aprobado durante el emparejamiento |
| Google Drive | OAuth (PKCE) | Se aprueba la cuenta del nuevo dispositivo y luego se comparte la carpeta |
| Dropbox | OAuth (PKCE) | Se aprueba la cuenta del nuevo dispositivo y luego se comparte la carpeta |
| OneDrive | OAuth (PKCE) | Se aprueba la cuenta del nuevo dispositivo y luego se comparte la carpeta |
| iCloud (CloudKit) | Apple ID, sin inicio de sesión | Compartir CloudKit aceptado durante el emparejamiento |
