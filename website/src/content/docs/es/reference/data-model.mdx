...
- **`releases`**: la entidad central, una fila por edición. Lleva los datos de edición (sello, número de catálogo, código de barras, país, formato, año), la fuente de metadatos, un hash de contenido de la carpeta importada y la sonoridad medida del álbum.
- **`release_identities`**: lo que un lanzamiento *es*, por fuente. Sin filas significa desconocido; una fila de MusicBrainz o Discogs con un release ID significa exacto; sin uno, aproximado. Un lanzamiento puede contener identidades en ambas fuentes a la vez.
...
- **`release_metadata`**: JSON sin procesar archivado de MusicBrainz y Discogs, guardado para reinterpretación futura.
- **`attribution_names`**: nombres de visualización para claves de miembros.
