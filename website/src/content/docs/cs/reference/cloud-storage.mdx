...
|---|---|---|
| Kompatibilní se S3 | Access key + secret | Přihlašovací údaje zapečetěné na schváleném zařízení během párování |
| Google Drive | OAuth (PKCE) | Účet nového zařízení byl schválen a složka je sdílena |
| Dropbox | OAuth (PKCE) | Účet nového zařízení byl schválen a složka je sdílena |
| OneDrive | OAuth (PKCE) | Účet nového zařízení byl schválen a složka je sdílena |
| iCloud (CloudKit) | Apple ID, bez přihlášení | Sdílení CloudKit přijato během párování |
