...
De sleutel reist op twee manieren tussen apparaten, beide beschreven in [Identiteit en lidmaatschap](/nl/reference/membership): verzegeld aan de openbare sleutel van een goedgekeurd apparaat tijdens het koppelen van apparaten, en opgenomen in een herstelcode.
