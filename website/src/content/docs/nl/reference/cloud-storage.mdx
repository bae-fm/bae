...
|---|---|---|
| S3-compatible | Access key + secret | Inloggegevens in de uitnodiging |
| Google Drive | OAuth (PKCE) | Map gedeeld met het account van de toetreder |
| Dropbox | OAuth (PKCE) | Map gedeeld met het account van de toetreder |
| OneDrive | OAuth (PKCE) | Map gedeeld met het account van de toetreder |
| iCloud (CloudKit) | Apple ID, geen login | CloudKit-share geaccepteerd door de toetreder |
