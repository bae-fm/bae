...
- **`source_release`** en de tabellen eronder: wat bae heeft geëxtraheerd uit elke opgehaalde release van MusicBrainz en Discogs — album- en persgegevens, de volledige tracklijst met credits en werken, hoesopties en hoe andere catalogi hem noemen — gecodeerd door providerrelease in plaats van door een lokale release. De ruwe JSON wordt niet bewaard; elk apparaat kan een release opnieuw ophalen.
