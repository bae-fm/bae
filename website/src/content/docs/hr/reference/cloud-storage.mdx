...
|---|---|---|
| S3-kompatibilno | Pristupni ključ + tajna | Vjerodajnice su zapečaćene na odobrenom uređaju tijekom uparivanja |
| Google Drive | OAuth (PKCE) | Račun novog uređaja odobren je, a zatim se mapa dijeli |
| Dropbox | OAuth (PKCE) | Račun novog uređaja odobren je, a zatim se mapa dijeli |
| OneDrive | OAuth (PKCE) | Račun novog uređaja odobren je, a zatim se mapa dijeli |
| iCloud (CloudKit) | Apple ID, bez prijave | CloudKit dijeljenje prihvaćeno tijekom uparivanja |
