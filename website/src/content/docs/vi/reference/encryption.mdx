...
Khóa di chuyển giữa các thiết bị theo hai cách, cả hai đều được mô tả trong [Danh tính và thành viên](/vi/reference/membership): được gắn vào khóa chung của thiết bị đã được phê duyệt trong quá trình ghép nối thiết bị và được chứa bên trong mã khôi phục.
