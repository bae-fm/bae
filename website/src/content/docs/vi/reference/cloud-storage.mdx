...
|---|---|---|
| Tương thích S3 | Access key + secret | Thông tin xác thực được niêm phong cho thiết bị được phê duyệt trong quá trình ghép nối |
| Google Drive | OAuth (PKCE) | Tài khoản của thiết bị mới đã được phê duyệt, sau đó thư mục sẽ được chia sẻ |
| Dropbox | OAuth (PKCE) | Tài khoản của thiết bị mới đã được phê duyệt, sau đó thư mục sẽ được chia sẻ |
| OneDrive | OAuth (PKCE) | Tài khoản của thiết bị mới đã được phê duyệt, sau đó thư mục sẽ được chia sẻ |
| iCloud (CloudKit) | Apple ID, không đăng nhập | Chia sẻ CloudKit được chấp nhận trong quá trình ghép nối |
