...
impl AppServices {
    ...
    #[cfg(not(any(target_os = "ios", target_os = "android")))]
    delegate_async!(manager, reset_release_edit_to_source => reset_release_edit_to_source(release_id: &str) -> Result<crate::import::ReleaseFormReset, crate::library::LibraryError>);
