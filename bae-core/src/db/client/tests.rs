...
/// `ARTIST_PRIMARY` owns `ALBUM_A`, whose primary release is `RELEASE_A`.
/// Callers add whatever hangs off it — tracks, covers, extra artists — in their
/// own batch afterwards.
