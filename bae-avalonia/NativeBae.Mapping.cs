...
internal static partial class NativeBae
{
    ...
    private static Settings Settings(
        ...
        new()
        {
            ...
            AutomaticImportMetadataLookup = config.AutomaticImportMetadataLookup,
            DefaultImportMetadataMode = config.DefaultImportMetadataMode,
            LastImportMetadataMode = config.LastImportMetadataMode,
            ResolvedImportMetadataMode = config.ResolvedImportMetadataMode,
