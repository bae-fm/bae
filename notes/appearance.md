...
Blue/Indigo/Purple/Pink/Red/Amber/Green/Teal accent, and Neutral/Slate/Plum
background tone. Defaults are System, Blue, and Neutral. Each tone defines both
light and dark surfaces. Preferences belong to the app installation rather than
...
controls. Accent text and glyphs use the mode-specific accent. Primary buttons
use the separate fill color with white text to preserve contrast in both modes.
...
three tones. Avalonia captures accept `--capture-variant`, `--capture-tone`, and
